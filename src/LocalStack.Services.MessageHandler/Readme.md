...
Execute unit tests
```
    cd "LocalStack.Services.MessageHandler/test/LocalStack.Services.MessageHandler.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "LocalStack.Services.MessageHandler/src/LocalStack.Services.MessageHandler"
